...
public class M12PreciseMapleFileTrainer<I, O> {
	...
	public <K> M12PreciseMaple<I, O> train(
		...
		try ( BasicRook rook = new BasicRook( ) ) {
			...
			M12PreciseMaple<I, O> maple = M12PreciseMapleFileDeserializer.deserialize(
					progress_spawner,
