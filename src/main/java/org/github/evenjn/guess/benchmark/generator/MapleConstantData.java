 ...
 * tuple where all the elements are the, except possibly the first one, and with
 * some random noise.
 *
 */
public class MapleConstantData implements
	...
	public MapleConstantData(boolean initial, boolean value) {
	...
	public BenchmarkDatum<Tuple<Boolean>, Tuple<Boolean>>
		...
		int size = 12 + input_size.nextInt( 5 );
		...
		good_output.add( initial );
		for ( int i = 1; i < size; i++ ) {
			good_output.add( value );
		}
