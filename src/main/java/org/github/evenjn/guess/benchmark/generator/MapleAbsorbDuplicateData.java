...
/**
 * A stream of data where the input tuple is transformed into a tuple that is a
 * copy of the input except that "false" elements are missing, and "true"
 * elements are duplicated (with some random noise).
 * 
 */
public class MapleAbsorbDuplicateData implements
	...
	public BenchmarkDatum<Tuple<Boolean>, Tuple<Boolean>>
		...
		int size = 20 + input_size.nextInt( 20 );
